...
- If Render keeps rejecting the JSON, delete the old `FIREBASE_SERVICE_ACCOUNT_JSON` secret and use `FIREBASE_SERVICE_ACCOUNT_JSON_B64` with a base64-encoded copy of the same service-account file.
